...
int main(void)
{
	...
	printf("(8) 리스트 맨 뒤에 [토] 노드 삭제하기!\n");
	pre = searchNode(L, "토");
	deleteNode(L, pre);
	printList(L); getchar();

	printf("(9) 리스트 맨 앞에 [월] 노드 삭제하기!\n");
	pre = searchNode(L, "월");
	deleteNode(L, pre);
	printList(L); getchar();

	printf("(10) 리스트 중간에 [수] 노드 삭제하기!\n");
	pre = searchNode(L, "수");
	deleteNode(L, pre);
	printList(L); getchar();

	printf("(11) 리스트 중간에 [금] 노드 삭제하기!\n");
	pre = searchNode(L, "금");
	deleteNode(L, pre);
	printList(L); getchar();

	printf("(12) 리스트 중간에 [목] 노드 삭제하기!\n");
	pre = searchNode(L, "목");
	deleteNode(L, pre);
	printList(L); getchar();

	printf("(13) 리스트에 홀로 남은 [화] 노드 삭제하기!\n");
	pre = searchNode(L, "화");
	deleteNode(L, pre);
	printList(L); getchar();

	printf("(14) 리스트 공간을 해제하여 공백 리스트로 만들기!\n");
	//freeLinkedList_h(L);
	//printList(L); getchar();
